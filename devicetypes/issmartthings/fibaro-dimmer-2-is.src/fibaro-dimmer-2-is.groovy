 ...
 *****************************************************************************************************************/
metadata {
    definition (name: "Fibaro Dimmer 2 IS", namespace: "issmartthings", author: "ivarsand") {
        capability "Actuator"
        capability "Switch"
...
def on() {
    /**
     *  Turn the dimmer on. [Capability: Switch]
     **/
...
def off() {
    /**
     *  Turn the dimmer off.  [Capability: Switch]
     **/
...
def setLevel(level) {
    /**
     *  Set the dimmer level.  [Capability: Switch Level]
     *
     *  Parameters:
...
def refresh() {
    /**
     *  Request switchMultilevel, energy, and power reports. [Capability: Refresh]
...
def poll() {
    /**
     *  Calls refresh(). [Capability: Polling]
     **/
    logger("poll()","trace")
    refresh()
}
